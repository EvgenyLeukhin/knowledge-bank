...
Простой пример: умножение двух чисел, записанное в каррированном виде — сначала одно число, потом второе.
...
Для сравнения, без каррирования то же самое выглядело бы так:
