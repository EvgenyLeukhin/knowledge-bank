...
Apple  > «Системные настройки», нажмите «Основные» в боковом меню, затем нажмите «Объекты входа и разширения»

#### Punto Switcher

"Конфиденциальность и безопасность" --> Универсальный доступ --> Punto Switcher (включить)
