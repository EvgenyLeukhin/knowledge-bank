...
- user - БЛОК.
- user\_\_name - ЭЛЕМЕНТ БЛОКА.
- user--background - МОДИФИКАТОР БЛОКА.
- user\_\_role--underline - МОДИФИКАТОР ЭЛЕМЕНТА БЛОКА.
...
2. CSS-класс элемента формируется так: класс-блока\_\_класс-элемента
...
5. Частая ошибка: в имени элемента пишут два сегмента \_\_. Не надо так.
...
<div class="header_big">
  <!-- Праильно -->
  <div class="header header_big"></div>
</div>
```
