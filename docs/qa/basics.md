...
3. ### По степени важности тестируемых функций:
    ...
    - **Sanity testing** (санитарное) - тестирование относительно стабильной сборки, чтобы убедиться, что известные ошибки прошлой версии уже исправлены (более углубленное, чем smoke)
