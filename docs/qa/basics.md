...
Тестирование **по сценарию** -> когда **есть тестовая документация**.

Тестирование **без сценария** -> когда **нет тестовой документации** (Свободное тестирование, Monkey-testing, на основе опыта тестировщика).
