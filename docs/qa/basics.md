...
3. ### По степени важности тестируемых функций:
    ...
    - **Sanity testing** (санитарное) - Как smoke, только более глубокое. Если smoke делается при каждом билде, чтобы убедиться что билд стабильный, то Sanity делается уже на стабильном билде, чтобы убедиться что все критические функции работают.
...
<div>
    <img src="../../../img/qa/verify.png" width="250" height="155" alt="verify" />
    &nbsp;
    <img src="../../../img/qa/validation.png" width="250" height="155" alt="validation" />
</div>

<!-- ![verify](/img/qa/verify.png) -->
<!-- ![validation](/img/qa/validation.png) -->
