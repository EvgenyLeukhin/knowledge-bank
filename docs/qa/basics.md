...
1. ### По виду функциональности работы приложения: 
    ...
    - **Нефункциональное** (по дополнительным параметрам, должно отвечать на вопрос: "Как?")
        ...
        - **Локализация** 
            - Язык
            - Интернационализация (Особенности страны)
            - Формат времени
            - Валюта
            - Ед. измерения и др.
...
3. ### По степени важности тестируемых функций:
    - **Дымовое** (smoke-testing, проверка только свмого важного и основного функционала, без которого приложение бесполезно, критические функции), 
    ...
    - **Sanity testing** - тестирование относительно стабильной сборки, чтобы убедиться, что известные ошибки прошлой версии уже исправлены (более углубленное чем smoke)
