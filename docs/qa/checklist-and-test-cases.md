...
- Предусловия: *описываем необходимые предварительные условия*
- Шаги: *шаги для воспроизведения*
- Фактический результат: *что мы получаем в результате выполнения шагов*
- Ожидаемый результат: *что должно происходить на самом деле*
- Скриншот/видео: *пруфы, подтверджающие вышесказанное*
- Окружение: *в какой среде воспроизводится баг*
