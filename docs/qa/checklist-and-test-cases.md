...
|ID|Title|Author|Module/Submodule|Priority|Requirements|Enviroment|Precondition|Steps|Expected result|Status|Comments|Testing level|
|---|---|---|---|---|---|---|---|---|---|---|---|---|
|TC1|Проверка&nbsp;отправки&nbsp;email|Tester|Регистрация/Форма регистрации|Средний|Some link|OS: MacOS 12.6, Google Chrome 105|1.Открыта форма 2.Пользователь не&nbsp;зарегистрирован|1.Step1 2.Step2 3.Step3|Email&nbsp;отправлен пользователю|Success|Some comments|Smoke/Positive|
...
### Виды тестирования у тест-кейсов
 ...
 Сначала проверяются позитивные, потом негативные. Нет смысла проверять негативные, если позитивные фейлятся.зexamples

- **Позитивный** - корректные входные данные. Цель - убедиться, что все работает правильно, как и задумывалось (большинство пользователей).
- **Негативный** - некорректные входные данные. Цель - убедиться, что система не ломается и остаётся стабильной, даже при вводе неправильных данных.
...
Диапозоны. Группировка. 

### Техника предугадывания ошибок

А что будет если? Случаи, когда могут возникнуть ошибки
