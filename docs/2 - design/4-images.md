...
Если скачались файлы с разширением .gif, то их можно сразу загружать в соц. сети, если скачались файлы с расширением .webp, то нужно их конвертировать в .gif, например через сервис [webp-to-gif](https://www.freeconvert.com/convert/webm-to-gif).
