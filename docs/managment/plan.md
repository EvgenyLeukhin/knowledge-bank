...
Нужно проверить идею заказчика. **Изучи** (проверь гипотезы) -> **Построй** (теоритическая идея MVP) -> **Измерь** (подсчет затрат и примерной прибыли).
...
- не стоит сильно прогнозировать на будущее
