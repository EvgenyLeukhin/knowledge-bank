...
Если работаете в рамках одной библиотеки, то создавать каждый раз проект не нужно, можно создавать `New Event` в рамках библиотеки и дальше уже импортировать файлы и монтировать.
