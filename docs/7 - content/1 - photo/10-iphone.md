...
1. В Adobe `Lightroom` как обычную raw-фотографию.
2. Во встроенном редакторе приложения "Фото" на iOS. Если нужно быстро отредактировать "прямо на устройстве".
3. Во встроенном редакторе приложения "Фото" на Mac OS. (`Открыть` фото в медиатеке --> `Редактировать`)
