...
1. Хэдер --> Купить криптовалюту --> P2P-торговля
2. Выбираем покупку или продажу
3. Указываем токен и сумму

<img src="../../../../img/frontend/p2p-buy.png" alt="p2p-buy.png" />

4. Переходим на ордер и производим оплату по указанным реквизитам и подтверждаем оплату. 
5. В чат с продавцом отправляем скриншот перевода и ждем когда продавец переведет токены.

<img src="../../../../img/frontend/order.png" alt="order.png" />

6. Если монеты пришли, то подтверждаем получение
