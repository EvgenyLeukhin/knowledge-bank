        ...
        <div className='container' style={{ textAlign: 'center' }}>
          ...
          <p className='hero__subtitle'>
            <ul style={{ listStyle: 'none', paddingLeft: 0 }}>
              <li>
                <b>ПРАКТИЧЕСКИЕ</b>
                <br /> (фреймворк, работа с API данными, стейтом, код) - MOST
                WANTED!!!
              </li>
              <li>↑</li>
              <li>
                <b>ИНСТРУМЕНТАЛЬНЫЕ</b>
                <br /> (редактор, браузер, программы, сервисы)
              </li>
              <li>↑</li>
              <li>
                <b>ФУНДАМЕНТАЛЬНЫЕ</b>
                <br /> (справочные, теория HTML/CSS/JS)
              </li>
            </ul>
          </p>
          <hr />
          ...
          <div style={{ textAlign: 'left' }}>
            - <b>MOBILE</b>: React Native, Expo, ReactQuery, Async Storage,
            Tailwind (позволяет кастомизировать стили комронентов) <br />-{' '}
            <b>BACKEND</b>: Nodejs, Express, Nest.js, Prisma, Loopback ???,
            MongoDB, PostgreSQL
            <br />- <b>DESKTOP</b>: Electron app, PWA
            <br />
          </div>
        </div>
        {/* <HomepageFeatures /> */}
